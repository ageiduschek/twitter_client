...
Twitter Client is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes the [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] Only makes Twitter API calls for data we've never fetched before
* [x] No disk I/O on the UI thread
